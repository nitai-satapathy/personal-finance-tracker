    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">💾 Data Storage Options</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-orange-50 rounded-lg p-4">
                <h3 className="font-semibold text-orange-800 mb-2">🏠 Local Storage Only</h3>
              ...
              <div className="bg-purple-50 rounded-lg p-4">
                <h3 className="font-semibold text-purple-800 mb-2">☁️ Cloud Sync (Optional)</h3>
          ...
          {/* Data Protection */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">🛡️ Data Protection & Security</h2>
          ...
          {/* Your Rights */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">⚖️ Your Rights & Control</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">⚠️ Important Limitations</h2>
          ...
          <section className="mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-gray-800 mb-3">📤 Data Backup</h3>
          ...
          {/* Legal Disclaimer */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">⚖️ Legal Disclaimer</h2>
          ...
          {/* Contact & Support */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">📞 Questions or Data Requests?</h2>
